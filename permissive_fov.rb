=begin
  Permissive field of view. Implementation grabbed from
...
module PermissiveFieldOfView
  ...
  def do_fov(start_x, start_y, radius, map_size_x, map_size_y)
    ...
    max_extent_x = [map_size_x - @start_x - 1, radius].min
    min_extent_y = [@start_y, radius].min
    max_extent_y = [map_size_y - @start_y - 1, radius].min
